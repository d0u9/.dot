...
| mise | Optional development-tool version manager. When installed, the Bash and Zsh configurations activate it so project tool versions switch automatically on directory changes. |
